#' Filter_Inf
#'
#'Filter_Inf not only filter the primer pairs, but also extract the basical information for each primer
#'
#' @param hot.pair is the primer pair
#' @param plist is the list formation of  Primers under each target sequence
